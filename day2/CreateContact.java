...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("ddd");
		driver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("kkk");
		driver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("Sss");
		...
		driver.findElement(By.xpath("//input[@id='createContactForm_primaryEmail']")).sendKeys("divsim@gmail.com");
		...
		Select	 ddGenOption = new Select(ddGenState);
				 ddGenOption.selectByVisibleText("Canada");
