...
public class FaceBookAssign {
	...
	public static void main(String args[]) {
		...
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("sim");
		driver.findElement(By.xpath("//input[@name='reg_email__']")).sendKeys("divsim@gmail.com");
